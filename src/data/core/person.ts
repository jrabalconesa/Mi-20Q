...
export const coreCandidates: Candidate[] = [
  ...
  { id: 'frida', name: 'Frida Kahlo', category: 'person', attributes: { realPerson:true, living:false, historical:true, artist:true, visualArtist:true, sports:false, scientist:false, politician:false, writer:false, woman:true, europe:false, americas:true, asia:false, africa:false, bornBefore1900:false, bornBefore1800:false, bornAfter1950:false, hispanic:true } },
