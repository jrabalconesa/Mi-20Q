...
const expandedSemanticQuestions: Question[] = [
  { id: 'animal_mammal', text: '¿Es un mamífero?', attribute: 'mammal', categories: animal, importance: 1.2, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_bird', text: '¿Es un ave?', attribute: 'bird', categories: animal, importance: 1.1, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_fish', text: '¿Es un pez?', attribute: 'fish', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_reptile', text: '¿Es un reptil?', attribute: 'reptile', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_amphibian', text: '¿Es un anfibio?', attribute: 'amphibian', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_arachnid', text: '¿Es un arácnido?', attribute: 'arachnid', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_mollusk', text: '¿Es un molusco?', attribute: 'mollusk', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_crustacean', text: '¿Es un crustáceo?', attribute: 'crustacean', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_vertebrate', text: '¿Es un animal vertebrado?', attribute: 'vertebrate', categories: animal, semanticGroup: 'animal-taxonomy' },
  { id: 'animal_insect', text: '¿Es un insecto?', attribute: 'insect', categories: animal, semanticGroup: 'animal-taxonomy' },
