...
const sampleTargets: Record<Category, string[]> = {
  ...
  person: ['Mahatma Gandhi', 'Pedro Sánchez', 'Barack Obama', 'Nelson Mandela', 'Cleopatra', 'Don Quijote de la Mancha', 'Fernando Alonso', 'Rosalía', 'Julio César', 'Elon Musk', 'Hipatia de Alejandría', 'Zeus', 'Poseidón', 'Afrodita', 'Hércules', 'Ulises', 'Cupido', 'Ares', 'Marte', 'Minotauro', 'Atenea', 'Medusa', 'Perseo', 'Orión', 'Casiopea', 'Centauro', 'Sherlock Holmes', 'Harry Potter', 'Mafalda']
}
